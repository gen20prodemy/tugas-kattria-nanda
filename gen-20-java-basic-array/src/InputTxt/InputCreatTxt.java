...
public class InputCreatTxt {
    public static void buatFile(){
        try {
            ...
            writer.write("\n 1. gunakan class \"BufferedWriter\" " +
                                "untuk memasukkan inputan string" +
                                " dan  \"FileWriter\" untuk membuat file tersebut");
            writer.write("\n 2. gunakan perintah \"writer.(nama object bufferedWriter)\" " +
                    "           untuk mengetik atau mengisi file ");
            writer.close();
        } catch (IOException e) {
