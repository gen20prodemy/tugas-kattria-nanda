...
public class CategoryController {
    ...
    public ResponseEntity <ResponseData<CategoryDto>> addCategory (@Valid @RequestBody CategoryDto categoryDto, Errors errors){
    ...
    // public CategoryDetailDto getDetailCategoies(@PathVariable int id) {
    //     return categoryService.detailCategories(id);
    // }
    ...
    // public List<CategoryDetailDto> getAllCategoriesProductCount() {
